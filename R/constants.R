marker_dict <- list(
   ...
   "6" =  list(glyph = "InvertedTriangle",  line = TRUE,  fill = FALSE),
   "7" =  list(glyph = "SquareX",           line = TRUE,  fill = FALSE),
   "8" =  list(glyph = "Asterisk",          line = TRUE,  fill = FALSE),
   "9" =  list(glyph = "DiamondCross",      line = TRUE,  fill = FALSE),
   "10" = list(glyph = "CircleCross",       line = TRUE,  fill = FALSE),
   "12" = list(glyph = "SquareCross",       line = TRUE,  fill = FALSE),
   "13" = list(glyph = "CircleX",           line = TRUE,  fill = FALSE),
   ...
   "25" = list(glyph = "InvertedTriangle", line = TRUE,  fill = TRUE),
   asterisk          = list(glyph = "Asterisk", line = TRUE, fill = FALSE),
   circle            = list(glyph = "Circle", line = TRUE, fill = TRUE),
   circle_cross      = list(glyph = "CircleCross", line = TRUE, fill = TRUE),
   circle_x          = list(glyph = "CircleX", line = TRUE, fill = TRUE),
   cross             = list(glyph = "Cross", line = TRUE, fill = FALSE),
   diamond           = list(glyph = "Diamond", line = TRUE, fill = TRUE),
   diamond_cross     = list(glyph = "DiamondCross", line = TRUE, fill = TRUE),
   inverted_triangle = list(glyph = "InvertedTriangle", line = TRUE, fill = TRUE),
   square            = list(glyph = "Square", line = TRUE, fill = TRUE),
   square_cross      = list(glyph = "SquareCross", line = TRUE, fill = TRUE),
   square_x          = list(glyph = "SquareX", line = TRUE, fill = TRUE),
...
tableau_colors <- list(
  ...
  Tableau10Light = c("#AEC7E8", "#FFBB78", "#98DF8A", "#FF9896", "#C5B0D5", "#C49C94",
    "#F7B6D2", "#C7C7C7", "#DBDB8D", "#9EDAE5"),
  Tableau10Medium = c("#729ECE", "#FF9E4A", "#67BF5C", "#ED665D", "#AD8BC9", "#A8786E",
    "#ED97CA", "#A2A2A2", "#CDCC5D", "#6DCCDA"),
  Tableau20 = c("#1F77B4", "#AEC7E8", "#FF7F0E", "#FFBB78", "#2CA02C", "#98DF8A",
    "#D62728", "#FF9896", "#9467BD", "#C5B0D5", "#8C564B", "#C49C94", "#E377C2",
    "#F7B6D2", "#7F7F7F", "#C7C7C7", "#BCBD22", "#DBDB8D", "#17BECF", "#9EDAE5"),
  TrafficLight = c("#B10318", "#DBA13A", "#309343", "#D82526", "#FFC156", "#69B764",
